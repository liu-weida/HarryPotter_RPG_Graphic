...
public class Chapter15 extends Application {
    ...
    private String[] dialogues = {
            "You have defeated the trolls and completed Dumbledore's mission.",
            "After returning to school, you received a compliment from Dean Dumbledore.",
            "[Congratulations you have successfully defeated the troll and you are in level 2!]",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter14.jpg");
