...
public class Combat2Spell4 extends Application {

    private TextArea textArea;

    private TextField textField;
    private ImageView imageView;
    private Image Combat2Spell;
    ...
    public void start(Stage stage) throws Exception {
        ...
        Game.wizard.attack(Game.wizard, Boss.basilic, Spell.diffindo);
        ...
        imageView = new ImageView(Combat2Spell);
