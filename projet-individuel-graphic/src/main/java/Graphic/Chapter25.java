...
public class Chapter25 extends Application {
    ...
    private String[] dialogues = {
            "You think of Minerva McGonagall's command and decide to overcome your fears and summon the legendary sword of Godric Gryffindor with courage and loyalty to defeat your enemies.",
            "With your call, the legendary sword of Godric Gryffindor appears and it turns into a light and rushes towards Basilic.",
            "The giant snake was knocked down, but not dead.",
            "Quickly destroy it with magic.",
    };
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter25.jpg");
