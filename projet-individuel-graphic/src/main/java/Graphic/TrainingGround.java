...
public class TrainingGround extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/TrainingGround0.jpg");
    ...
    private void showNextScene() {
        Enemy.gargoyle.setHP(100);
        TrainingGround2 trainingGround2 = new TrainingGround2();
        try {
            trainingGround2.start(mainStage);
        } catch (Exception e) {
            e.printStackTrace();
