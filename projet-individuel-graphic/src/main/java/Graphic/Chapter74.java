...
public class Chapter74 extends Application {
    ...
    private String[] dialogues = {
            "Finally, Voldemort falls under your attack and it's all over.",
            "You feel as if all this is a dream that is not real, but the wreckage and bodies everywhere tell you that it is all real.",
            "You hugged Jim's body and cried out, as if you were mourning Jim, and as if you were glad it was over.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter74.jpg");
