...
public class Chapter72 extends Application {
    ...
    private String[] dialogues = {
            "They rushed to Hogwarts, and instantly, everyone at the college went into battle.",
            "A guardian stone statue fell, a magical light rose to the sky, and everyone did their best to resist Voldemort and the Death Eaters.",
            "You also joined your classmates and professors, rebelling against Voldemort with a spell.",
            "Just when you're in the middle of a good fight, you see Bellatrix Lestrange flying towards you with her staff raised.",
            "You strike first with an attack spell.",
    };
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter72.jpg");
...
//        scene.setCursor(new ImageCursor(cursorImage));
    ...
    private void showNextScene() {
        Boss.bellatrixLestrange.setHP(900);
        Combat7StartPage chapter71 = new Combat7StartPage();
        try {
