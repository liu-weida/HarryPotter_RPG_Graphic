...
public class Combat4StartPage extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat4Spell combatSpell = new Combat4Spell();
        ...
        buttonCreate2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat4Potion combatPotion = new Combat4Potion();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate3.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat4ForbiddenSpell combatForbiddenSpell = new  Combat4ForbiddenSpell();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate4.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat4Defense combatDefense = new Combat4Defense();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
