...
public class Combat6Spell extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                    Combat6Spell1 CombatSpell1 = new Combat6Spell1();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat6Spell2 CombatSpell2 = new Combat6Spell2();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate3.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat6Spell3 CombatSpell3 = new Combat6Spell3();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate4.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat6Spell4 CombatSpell4 = new Combat6Spell4();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate5.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat6Spell5 CombatSpell5 = new Combat6Spell5();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate6.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat6Spell6 CombatSpell6 = new Combat6Spell6();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate7.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat6Spell7 CombatSpell7 = new Combat6Spell7();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
