...
public class Chapter67 extends Application {
    ...
    private String[] dialogues = {
            "With the defeat of the leader of the Death Eaters, the siege of Hogwarts Death Eaters also gradually dispersed.",
            "You got the win.",
            "But you also know that this is not the first time, and will not be the last, it is time to make a break with Voldemort.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter68.jpg");
