...
public class Chapter52 extends Application {
    ...
    private String[] dialogues = {
            "You approach the warehouse and say hello to Dolores Ombrage.",
            "What are you doing here? Dolores Ombrage asked you sternly.",
            "Without speaking, you strike out with a spell.",
    };
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter52.jpg");
...
//        scene.setCursor(new ImageCursor(cursorImage));
    ...
    private void showNextScene() {
        Boss.doloresOmbrage.setHP(600);
        Combat5StartPage chapter42 = new Combat5StartPage();
        try {
