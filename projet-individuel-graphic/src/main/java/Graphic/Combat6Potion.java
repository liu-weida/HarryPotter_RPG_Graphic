...
public class Combat6Potion extends Application{

    private ImageView imageView;
    private Image Combat6Potion1;
    private Image Combat6Potion2;
    private Image Combat6Potion3;
    private Image Combat6Potion4;
    private Image Combat6Potion5;
    private Image Combat6Potion6;
    private Image Combat6Potion7;
    private Image Combat6Potion8;
    private Image Combat6Potion9;
    private Image Combat6Potion10;
    private Image Combat6Potion11;
    private Image Combat6Potion12;
    private Image Combat6Potion13;
    private Image Combat6Potion14;
    ...
    public void start(Stage stage) throws Exception {
        ...
        switch (n){
            case 0:
                ...
                break;
            case 1:
                imageView = new ImageView(Combat6Potion1);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion2);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat6Potion1);
                });

                break;
            case 2:
                imageView = new ImageView(Combat6Potion3);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion4);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat6Potion3);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion5);
                });
                ...
                break;
            case 3:
                imageView = new ImageView(Combat6Potion6);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion7);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat6Potion6);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion8);
                });
                ...
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion9);
                });
            ...
            default:
                imageView = new ImageView(Combat6Potion10);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion11);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat6Potion10);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion12);
                });
                ...
                // 添加鼠标移入事件监听器
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion13);
                });
                ...
                buttonCreate4.setOnMouseEntered(event -> {
                    imageView.setImage(Combat6Potion14);
                });
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Combat6Potion1 combatPotion1 = new Combat6Potion1();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
