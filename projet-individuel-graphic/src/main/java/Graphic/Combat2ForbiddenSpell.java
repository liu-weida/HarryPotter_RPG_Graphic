...
public class Combat2ForbiddenSpell extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat2ForbiddenSpell1 combatForbiddenSpell1 = new Combat2ForbiddenSpell1();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat2ForbiddenSpell2 combatForbiddenSpell2 = new Combat2ForbiddenSpell2();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate3.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat2ForbiddenSpell3 combatForbiddenSpell3 = new Combat2ForbiddenSpell3();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
