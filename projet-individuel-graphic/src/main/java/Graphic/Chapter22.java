...
public class Chapter22 extends Application {
    ...
    private String[] dialogues = {
            "\"Don't forget that you are a Gryffindor and that you can summon the legendary sword of Godric Gryffindor in times of need through courage and loyalty. \"",
            "Before your departure your Dean Minerva McGonagall instructed you.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter22.jpg");
