...
public class Chapter26 extends Application {
    ...
    private String[] dialogues = {
            "You then pulled Basilic's fangs and used them to destroy Tom Riddle's diary.",
            "Upon your return to the college, you once again received a warm welcome from all your fellow students and professors.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter23.jpg");
