...
public class Chapter21 extends Application {
    ...
    private String[] dialogues = {
            "After a period of rest, you received an order from Dean Dumbledore.",
            "\"Kid，go and defeat the Basilic in the chamber, then destroy Tom Riddle's diary with its fangs.\" ",
            "Dean Dumbledore has said",
    ...
    public void start(Stage stage) throws Exception {
        ...
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter21.jpg");
