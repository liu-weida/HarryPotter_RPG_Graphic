...
public class PropertyDisplayInitial2 extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        InputStream input1 = getClass().getResourceAsStream("/image/PropertyDisplayInitial3.jpg");
        AssignWand1 = new Image(input1);

        InputStream input2 = getClass().getResourceAsStream("/image/PropertyDisplayInitial4.jpg");
        ...
        buttonCreate.setPrefSize(205, 80);
