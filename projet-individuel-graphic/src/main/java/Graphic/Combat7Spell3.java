...
public class Combat7Spell3 extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Game.wizard.attack(Game.wizard, Boss.bellatrixLestrange, Spell.locomotorMortis);
        ...
        if (Boss.bellatrixLestrange.getHP() > 0) {
            Boss.bellatrixLestrange.attack(Game.wizard, Boss.bellatrixLestrange, Game.spells.get(0));
            ...
            String newString = "Battle won, level +1,gold+ "+Boss.bellatrixLestrange.getGold();
            Game.wizard.setGold(Game.wizard.getGold()+Boss.bellatrixLestrange.getGold());
            dialogues = Arrays.copyOf(dialogues, dialogues.length + 1); // 扩展数组长度
            dialogues[dialogues.length - 1] = newString; // 添加新字符串到数组
        }
        ...
        textField2.setText(String.valueOf(Boss.bellatrixLestrange.getHP()));
