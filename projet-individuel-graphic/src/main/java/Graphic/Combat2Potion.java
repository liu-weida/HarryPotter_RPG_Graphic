...
public class Combat2Potion extends Application{

    private ImageView imageView;
    private Image Combat2Potion1;
    private Image Combat2Potion2;
    private Image Combat2Potion3;
    private Image Combat2Potion4;
    private Image Combat2Potion5;
    private Image Combat2Potion6;
    private Image Combat2Potion7;
    private Image Combat2Potion8;
    private Image Combat2Potion9;
    private Image Combat2Potion10;
    private Image Combat2Potion11;
    private Image Combat2Potion12;
    private Image Combat2Potion13;
    private Image Combat2Potion14;
    ...
    public void start(Stage stage) throws Exception {
        ...
        switch (n){
            case 0:
                ...
                break;
            case 1:
                imageView = new ImageView(Combat2Potion1);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion2);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat2Potion1);
                });

                break;
            case 2:
                imageView = new ImageView(Combat2Potion3);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion4);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat2Potion3);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion5);
                });
                ...
                break;
            case 3:
                imageView = new ImageView(Combat2Potion6);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion7);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat2Potion6);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion8);
                });
                ...
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion9);
                });
            ...
            default:
                imageView = new ImageView(Combat2Potion10);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion11);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat2Potion10);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion12);
                });
                ...
                // 添加鼠标移入事件监听器
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion13);
                });
                ...
                buttonCreate4.setOnMouseEntered(event -> {
                    imageView.setImage(Combat2Potion14);
                });
...
>>>>>>> c31add4f7965e31170118d219d5ddf7199c9d4cc
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Combat2Potion1 combatPotion1 = new Combat2Potion1();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
