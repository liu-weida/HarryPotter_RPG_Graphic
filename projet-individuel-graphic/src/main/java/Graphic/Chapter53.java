...
public class Chapter53 extends Application {
    ...
    private String[] dialogues = {
            "You have received a message from your partners.",
            "You run away in a hurry.",
            "After meeting up with friends, the party officially started.",
            "You partied all night long and celebrated together.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter53.jpg");
