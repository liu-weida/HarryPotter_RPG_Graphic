...
public class Chapter23 extends Application {
    ...
    private String[] dialogues = {
            "After some fighting, you come to the secret room, where a great danger seems to be waiting for you.",
    };
