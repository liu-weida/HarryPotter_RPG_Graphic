...
public class Chapter33 extends Application {
    ...
    private String[] dialogues = {
            "With the Dementors dissipating in place, you know these Dementors will never dare to infest Hogwarts again, and you've successfully banished them!",
            "Back at House, you became a real star and everyone thanked you.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter33.jpg");
