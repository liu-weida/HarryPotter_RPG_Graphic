...
public class Chapter02 extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter02.jpg");
    ...
    private void showNextScene() {
        ArrivalHouse1 arrivalHouse1 = new ArrivalHouse1();
        try {
            arrivalHouse1.start(mainStage);
        } catch (Exception e) {
            e.printStackTrace();
