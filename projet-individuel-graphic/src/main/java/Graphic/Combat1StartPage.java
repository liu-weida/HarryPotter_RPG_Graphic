...
public class Combat1StartPage extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat1Spell combatSpell = new Combat1Spell();
        ...
        buttonCreate2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat1Potion combatPotion = new Combat1Potion();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate3.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat1ForbiddenSpell combatForbiddenSpell = new  Combat1ForbiddenSpell();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
        ...
        buttonCreate4.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // 创建 ArrivalHouse3 实例
                Combat1Defense combatDefense = new Combat1Defense();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
