...
public class Combat2Defense extends Application {
    ...
    private void nextDialogue() {
        if (currentDialogue < dialogues.length) {
            ...
            if (Game.property[1]<=0){
                ...
                PageTransition.smoothTransition(mainStage, mainStage.getScene().getRoot(), () -> showCombat2StartPage(mainStage));
            }

        }
    }

    private void showCombat2StartPage(Stage previousStage) {
        Combat2StartPage combat1StartPage = new Combat2StartPage();
        try {
