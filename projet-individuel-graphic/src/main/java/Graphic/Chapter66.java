...
public class Chapter66 extends Application {
    ...
    private String[] dialogues = {
            "You pick up your staff and rush in the direction of the Death Eaters' attack.",
            "You release a spell that knocks a Death Eater away, followed by a group of Death Eaters surrounding it.",
            "Just as you are surrounded, a light suddenly strikes, sending all the Death Eaters around you flying. It was Dean Dumbledore's help.",
            "\"Capture the thief, go and defeat the leader of this group of Death Eaters, and they will naturally retreat.\" Dumbledore said.",
            "Hearing the instructions of Dean Dumbledore, you resolutely rushed to the most dense area of the Death Eaters, where the leader of this group of Death Eaters is located.",
            "To protect the chief, the Death Eaters rush towards you.",
            "You use the spell to hit the Death Eaters while moving quickly to prevent being surrounded by them.",
            "Finally, after some hard fighting, you finally came to the leader of this group of Death Eaters, fortunately, not Voldemort."
...
//        scene.setCursor(new ImageCursor(cursorImage));
    ...
    private void showNextScene() {
        Boss.doloresOmbrageLeader.setHP(750);
            Combat6StartPage chapter63 = new Combat6StartPage();
        try {
            chapter63.start(mainStage);
        } catch (Exception e) {
            e.printStackTrace();
