...
public class Chapter62 extends Application {
    ...
    private String[] dialogues = {
            "You feel extreme fear at the sight of the incoming hordes of Death Eaters.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter62.jpg");
...
//        scene.setCursor(new ImageCursor(cursorImage));
    ...
    private void showNextScene() {
        Chapter63 chapter63 = new Chapter63();
        try {
