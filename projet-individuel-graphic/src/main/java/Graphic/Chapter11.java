...
public class Chapter11 extends Application {
    ...
    private String[] dialogues = {
            "\"Kid, this adventure is very dangerous, please be very careful. I divined for you yesterday and the stars show that you need Wingardium leviosa to help you with this adventure.\" Dean Dumbledore instructed. ",
            "After saying that, he taught you a brand new magic.",
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter15.jpg");
