...
public class Chapter51 extends Application {
    ...
    private String[] dialogues = {
            "After your last escape from death, you discovered the importance of learning magic, and during this time, you worked your ass off to learn all kinds of magic.",
            "Soon, exam of Universal Certificate of Elementary Witchcraft came.",
            "You and your buddies did well in the exam.",
            "To celebrate, you have decided to throw a big party.",
            "How can a grand party be without fireworks?",
            "But all of Hogwarts' fireworks are kept in storage.",
            "The Hogwarts warehouse is guarded by Dolores Ombrage.",
            "You and your partners decide that you will attract Dolores Ombrage's attention while the others sneak into the warehouse and take the fireworks.",
    };
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter51.jpg");
...
//        scene.setCursor(new ImageCursor(cursorImage));
    ...
    private void showNextScene() {
        Chapter52 chapter52 = new Chapter52();
        try {
            chapter52.start(mainStage);
        } catch (Exception e) {
            e.printStackTrace();
