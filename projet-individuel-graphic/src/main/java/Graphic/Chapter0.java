...
public class Chapter0 extends Application {
    ...
    private String[] dialogues = {
            "You spent a difficult childhood at your aunt's house as a child.",
            "On your eleventh birthday, you received a letter of admission to Hogwarts.",
            "The mysterious giant Hagrid appears and takes you on a magical journey.",
            "Finally, you board the Hogwarts Express and prepare to enter the wizarding world."
    };
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter01.jpg");
        ...
        // 设置自定义鼠标指针
        //InputStream cursorInput = new InputStream("C:\\Users\\86138\\IdeaProjects\\projet-individuel\\src\\main\\java\\Graphic\\image/custom_cursor.png");
