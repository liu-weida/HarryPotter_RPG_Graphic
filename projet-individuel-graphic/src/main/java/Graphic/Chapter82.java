...
public class Chapter82 extends Application {
    ...
    private String[] dialogues = {
            "After graduation, you joined the Ministry of Magic and became a commissioner of law enforcement.",
            "For you are sworn to punish all wizards who maliciously use forbidden magic.",
            "For more people like Jim.",
            "\"Jim ......\" you murmur, unable to help but think of that best friend of yours again.",
            "\""+ Game.wizard.getName()+"! "+"\"There's a new mission, and this time we're dealing with a wizard who used forbidden magic to slaughter muggles.\"",
                    "The captain's voice interrupted.",
            "You put on your wizard's hat, grabbed your wand, and rushed with the captain to the mission site……",
    };
    ...
    public void start(Stage stage) throws Exception {
        ...
        // 加载默认图像
        InputStream input1 = getClass().getResourceAsStream("/image/Chapter82.jpg");
