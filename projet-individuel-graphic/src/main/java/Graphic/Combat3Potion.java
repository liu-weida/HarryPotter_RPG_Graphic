...
public class Combat3Potion extends Application{

    private ImageView imageView;
    private Image Combat3Potion1;
    private Image Combat3Potion2;
    private Image Combat3Potion3;
    private Image Combat3Potion4;
    private Image Combat3Potion5;
    private Image Combat3Potion6;
    private Image Combat3Potion7;
    private Image Combat3Potion8;
    private Image Combat3Potion9;
    private Image Combat3Potion10;
    private Image Combat3Potion11;
    private Image Combat3Potion12;
    private Image Combat3Potion13;
    private Image Combat3Potion14;
    ...
    public void start(Stage stage) throws Exception {
        ...
        switch (n){
            case 0:
                ...
                break;
            case 1:
                imageView = new ImageView(Combat3Potion1);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion2);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat3Potion1);
                });

                break;
            case 2:
                imageView = new ImageView(Combat3Potion3);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion4);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat3Potion3);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion5);
                });
                ...
                break;
            case 3:
                imageView = new ImageView(Combat3Potion6);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion7);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat3Potion6);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion8);
                });
                ...
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion9);
                });
            ...
            default:
                imageView = new ImageView(Combat3Potion10);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion11);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat3Potion10);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion12);
                });
                ...
                // 添加鼠标移入事件监听器
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion13);
                });
                ...
                buttonCreate4.setOnMouseEntered(event -> {
                    imageView.setImage(Combat3Potion14);
                });
        ...
        textField2.setText(String.valueOf(Boss.dementor.getHP()));
...
>>>>>>> c31add4f7965e31170118d219d5ddf7199c9d4cc
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Combat3Potion1 combatPotion1 = new Combat3Potion1();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
