...
public class Combat4Spell4 extends Application {

    private TextArea textArea;

    private TextField textField;
    private ImageView imageView;
    private Image Combat4Spell;
    ...
    public void start(Stage stage) throws Exception {
        ...
        Game.wizard.attack(Game.wizard, Boss.peterPettigrew, Spell.diffindo);
        ...
        imageView = new ImageView(Combat4Spell);
    ...
    private void showBattleVictory(Stage previousStage) {
        BattleVictory4 battleVictory = new BattleVictory4();
        try {
    ...
    private void showCombatSpell(Stage previousStage) {
        Combat4StartPage combatStartPage = new Combat4StartPage();
        try {
