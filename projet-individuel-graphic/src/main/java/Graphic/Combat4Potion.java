...
public class Combat4Potion extends Application{

    private ImageView imageView;
    private Image Combat4Potion1;
    private Image Combat4Potion2;
    private Image Combat4Potion3;
    private Image Combat4Potion4;
    private Image Combat4Potion5;
    private Image Combat4Potion6;
    private Image Combat4Potion7;
    private Image Combat4Potion8;
    private Image Combat4Potion9;
    private Image Combat4Potion10;
    private Image Combat4Potion11;
    private Image Combat4Potion12;
    private Image Combat4Potion13;
    private Image Combat4Potion14;
    ...
    public void start(Stage stage) throws Exception {
        ...
        switch (n){
            case 0:
                ...
                break;
            case 1:
                imageView = new ImageView(Combat4Potion1);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion2);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat4Potion1);
                });

                break;
            case 2:
                imageView = new ImageView(Combat4Potion3);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion4);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat4Potion3);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion5);
                });
                ...
                break;
            case 3:
                imageView = new ImageView(Combat4Potion6);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion7);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat4Potion6);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion8);
                });
                ...
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion9);
                });
            ...
            default:
                imageView = new ImageView(Combat4Potion10);

                // 添加鼠标移入事件监听器
                buttonCreate1.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion11);
                });

                // 添加鼠标移出事件监听器
                buttonCreate1.setOnMouseExited(event -> {
                    imageView.setImage(Combat4Potion10);
                });

                // 添加鼠标移入事件监听器
                buttonCreate2.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion12);
                });
                ...
                // 添加鼠标移入事件监听器
                buttonCreate3.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion13);
                });
                ...
                buttonCreate4.setOnMouseEntered(event -> {
                    imageView.setImage(Combat4Potion14);
                });
        ...
        buttonCreate1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Combat4Potion1 combatPotion1 = new Combat4Potion1();
                // 调用 ArrivalHouse3 实例的 start() 方法显示新的场景
                try {
