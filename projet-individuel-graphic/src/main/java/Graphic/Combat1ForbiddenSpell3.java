...
public class Combat1ForbiddenSpell3 extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Game.wizard.forbiddenAttack(Game.wizard,Boss.troll, ForbiddenSpell.avadaKedavra);
    ...
    private void showBattleVictory(Stage previousStage) {
        BattleVictory1 battleVictory = new BattleVictory1();
        try {
