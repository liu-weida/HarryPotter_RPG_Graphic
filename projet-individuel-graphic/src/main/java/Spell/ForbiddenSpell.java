...
public class ForbiddenSpell extends AbstractSpell {
    ...
    public static final ForbiddenSpell avadaKedavra = new ForbiddenSpell("Avada Kedavra", 200, 0.4f);//阿瓦达啃大瓜
    public static final ForbiddenSpell imperio = new ForbiddenSpell("Imperio", 120, 0.5f);//魂魄出窍
